...
def create_geometry(parameters):
    ...
    gmsh.model.addPhysicalGroup(dim=2, tags=[end_surface_cs] + [external_surfaces[0]], tag=geo_parameters["physical_group_tag_end"])
    ...
    surface_tags = [
        ...
        if not surface_i[1] in external_surfaces[1:]
